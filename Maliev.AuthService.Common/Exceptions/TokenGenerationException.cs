...
{
    /// <summary>
    /// Represents an exception that occurs when token generation fails.
    /// </summary>
    public class TokenGenerationException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenGenerationException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
